...
export const mutationTypes = {
    ...
    onChangeRoute: '[auth] Reset validation',
...
export const actionTypes = {
    ...
    resetValidation: '[auth] reset validation',
    logout: '[auth] logout'
}
...
const mutations = {
    ...
    [mutationTypes.onChangeRoute](state) {
        state.validationErrors = null;
    },
...
const actions = {
    ...
    [actionTypes.getCurrentUser](context) {
        return new Promise(resolve => {
            ...
            authApi
                ...
                .catch(() => {
                    //Обнуление токена, если сервер не узнал клиента по токену /api/user
                    setItem('accessToken', '');
    ...
    [actionTypes.resetValidation](context) {
        return new Promise(resolve => {
            context.commit(mutationTypes.onChangeRoute);
            resolve();
        });
    }
}
